...
public class RunnableExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("bayes features : " + bayes.getFeatures());
        System.out.println("bayes featureCount : " + bayes.getTotalFeatureCount());
        System.out.println(bayes.getFeatureCountPerCategory());
