...
public abstract class Classifier<T, K> implements IFeatureProbability<T, K> {
     ...
     */
    private static final int INITIAL_FEATURE_DICTIONARY_CAPACITY = 10000;
...
//        this.memoryQueue = new LinkedList<Classification<T, K>>();
    ...
    // zewei.jiang add start
    public Dictionary<T, Integer> getTotalFeatureCount() {
    	return this.totalFeatureCount;
    }
    
    public void setTotalFeatureCount(Dictionary<T,Integer> totalFeatureCount) {
    ...
    public void setTotalCategoryCount(Dictionary<K,Integer> totalCategoryCount) {
    	this.totalCategoryCount = totalCategoryCount;
    }
    
    public Dictionary<K, Dictionary<T, Integer>> getFeatureCountPerCategory() {
    	return this.featureCountPerCategory;
    }
    
    public void setGeatureCountPerCategory(Dictionary<K,Dictionary<T,Integer>> featureCountPerCategory) {
